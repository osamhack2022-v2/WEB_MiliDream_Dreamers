...
export default function BoardNavBar({ category }) {
    console.log("boardnavbar category", category);
    category = [];
    return (
        <div>
                        ...
                        <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            {category.map((category) => (
                                <li key={category.categoryKey}>
                                    <a
                                        href={"/board/" + category.categoryKey}
